({
	upload: function(cmp, file, fileContents, templateName, templateGroup, templateDescription, helper) {
        helper.callAction(cmp, cmp.get("c.saveTheFile"),{
            ...
            //Good to go
            //Refresh both the list and table, and close the modal
            var refreshListAndTableEvent = cmp.getEvent("stepEvent");
      		refreshListAndTableEvent.setParams({eventAction: "refreshListAndTable"}).fire();
            });
    },
